...
class Character extends FlxSprite
{
	...
	public var healthColor:FlxColor= 0xFF66FF33; // Not currently used anymore, might use for time remaining.
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			// Please Note, healthColor is of no use yet, at least not anymore, might decide to use it for time remaining.
			...
			case 'torch':
				...
				animation.addByPrefix('dodge', 'Hey!', 24, false); //Test Dodge Only
		...
		if (!isPlayer)
		{
			if (curCharacter.startsWith('bf') || curCharacter.startsWith('torch'))
			{
				// var animArray
